...
import { ChartRendererViewer } from "@/app/view/chart-renderer/chart-renderer-viewer"
...
<Steps>
  **Copy and paste the following code into your project.**
  ...
  <Step>
  Add the `chart-renderer.tsx` file. 
  This file defines the `ChartRenderer` component, which handles rendering the chart visualization.

  ```json doc-gen:file
    {
      "file": "./components/chart/chart-renderer.tsx",
      "codeblock": {
        "lang": "tsx",
        "meta": "title=\"chart-renderer.tsx\""
      }
    }
  ```
  </Step>
...
```md
When generating charts with create_chart:
